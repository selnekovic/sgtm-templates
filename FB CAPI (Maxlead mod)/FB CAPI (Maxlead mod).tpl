...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "FB CAPI (Maxlead mod)",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
...
[
  ...
  },
  {
    "type": "CHECKBOX",
    "name": "contentType",
    "checkboxText": "Content type is product group",
    "simpleValueType": true,
    "help": "Enable if the keys you send in item_id parameter represent product groups. Product groups are used to distinguish products that are identical but have variations such as color, material, size or pattern."
  },
  {
    "type": "CHECKBOX",
    "name": "optEnabled",
    "checkboxText": "Opt out mode",
    "simpleValueType": true,
    "help": "Opt out mode flag indicates that Facebook should not use this event for ads delivery optimization, only for attribution."
  },
  {
    "type": "CHECKBOX",
    "name": "cfoEnabled",
    "checkboxText": "Enable \u0027fb_data\u0027 object",
    "simpleValueType": true,
    "help": "The tag can automatically read custom and user data from the \u0027fb_data\u0027 object (variable) sent with event parameters."
  },
  {
    "type": "GROUP",
    ...
    "subParams": [
      {
        "type": "CHECKBOX",
        "name": "cemEnabled",
        "checkboxText": "Enable Custom Event Mapping",
        "simpleValueType": true
      },
      {
        "type": "SIMPLE_TABLE",
    ...
    "subParams": [
      {
        "type": "CHECKBOX",
        "name": "udEnabled",
        "checkboxText": "Enable User Data",
        "simpleValueType": true
      },
      {
        "type": "SIMPLE_TABLE",
        "name": "customUserDataList",
        "simpleTableColumns": [
          {
            "defaultValue": "",
    ...
    "subParams": [
      {
        "type": "CHECKBOX",
        "name": "cdEnabled",
        "checkboxText": "Enable Custom Data",
        "simpleValueType": true
      },
      {
        "type": "SIMPLE_TABLE",
  ...
  },
  {
    "type": "GROUP",
    "name": "bigQuery",
    "displayName": "BigQuery Monitoring",
    "groupStyle": "ZIPPY_CLOSED",
    "subParams": [
      {
        "type": "CHECKBOX",
        "name": "bqEnabled",
        "checkboxText": "Enable BigQuery Monitoring",
        "simpleValueType": true
      },
      {
        "type": "TEXT",
      ...
      },
      {
        "type": "CHECKBOX",
        "name": "udToBQEnabled",
        "checkboxText": "Send user data to BigQuery",
        "simpleValueType": true,
        "enablingConditions": [
          {
            "paramName": "bqEnabled",
...
scenarios:
- name: TestGA4UserProvidedData
  code: "const mockEventData = {\n  event_name: 'page_view',\n  page_location: 'https://www.dase-analytics.com',\n\
    \  user_data: {\n    email: \"julo@dase.sk\",\n    phone_number: \"+421902123456\"\
    ,\n    address: [{\n      first_name: \"Julo\",\n      last_name: \"Dase\",\n\
    \      city: \"Bratislava\",\n      region: \"Bratislava\",\n      postal_code:\
    \ \"84101\",\n      country: \"Slovakia\"\n    }]\n  },\n};\n\nmock('getEventData',\
    \ () => { \n  return mockEventData.user_data;\n});\n\n// Call runCode to run the\
...
- name: TestItemsMapping
  code: "const mockEventData = {\n  event_name: 'view_item',\n  page_location: 'https://www.dase-analytics.com',\n\
    ...
    ,\n      price: 10.01,\n      quantity: 3\n    }\n  ]\n};\n\nmock('getEventData',\
    \ () => { \n  return mockEventData.items;\n});\n\n// Call runCode to run the template's\
    \ code.\nrunCode(mockData);\n\n// Verify that the tag finished successfully.\n\
    assertApi('gtmOnSuccess').wasCalled();\n"
- name: TestFBDataObject
  code: |
    mockData = {
      pixelId: '123456',
      apiAccessToken: 'AB12CD',
      cfoEnabled: true
    };
    ...
    const mockEventData = {
      event_name: 'page_view',
      page_location: 'https://www.dase-analytics.com',
      fb_data: '{\"user_data\":{\"external_id\":\"ext123\"},\"custom_data\":{\"customParam\":\"customValue\"}}'
    };
...
- name: TestCustomEventMapping
  code: |-
    ...
    // Verify that the tag finished successfully.
    assertApi('gtmOnSuccess').wasCalled();
- name: TestCustomUserDataMapping
  code: |-
    mockData = {
      pixelId: '123456',
      apiAccessToken: 'AB12CD',
...
setup: "const log = require('logToConsole');\n\nlet mockData = {\n  pixelId: '123456',\n\
  ...
  \  const body = arguments[3];\n  \n  log('sendHttpRequest', arguments);\n  \n  const\
  \ respStatusCode = 200;\n  const respHeaders = {};\n  const respBody = {};\n  callback(respStatusCode,\
...
Created on 11. 11. 2024 12:35:19
